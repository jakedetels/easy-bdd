...
fn.setupPage = function() {
  var isTestEnv = require.modulePrefix !== 'obey';
  var $body;
  
  this.$root = $('<div class="obey-root">');

  if (isTestEnv) {
    $body = $('.obey-fixture');
    this.$fixture = $('<div class="obey-fixture"></div>');
  } else {
    $body = $('body');
    this.$fixture = $('.obey-fixture');
    if (! this.$fixture.length) {
      this.$fixture = $('<div class="obey-fixture"></div>').appendTo('body');
    }
  }
