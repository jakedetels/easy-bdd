...
// var blanketTree = new Funnel(path.join(__dirname, '../../bower_components/blanket'), {
var blanketTree = new Funnel(path.join(bowerPath, 'blanket'), {
  destDir: 'blanket'
});
...
function compiler(options) {
  ...
  var trees = [easyBddTree, blanketTree, testsTree, testemJs];
  ...
  var runnerSupportJs = new Funnel(mergeTrees([runnerPath, path.join(bowerPath, 'loader.js')]), {
    include: ['**/*.js'],
